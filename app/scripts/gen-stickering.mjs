...
await writeFile(target, await formatted(next, target));
...
await mkdir(new URL("./", stagesPath), { recursive: true });
await writeFile(stagesPath, await formatted(JSON.stringify(stagesFile, null, 2), stagesPath));
